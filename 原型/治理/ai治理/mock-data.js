const GOV_MOCK = {
  ...
  topUsers: [
    ...
    { id: 'user_3301', ops: 38, risk: 'low', workspace: 'Global WorkSpace' }
  ],
  riskAlerts: [
    ...
    { id: 'ra4', level: 'medium', title: '权限变更', desc: 'admin 将 user_3301 提升为 Workspace 管理员', time: '2026-06-09 16:22', workspace: 'Global WorkSpace' },
  ...
  auditLogs: [
    ...
    { id: 'aud_04', createdAt: '2026-06-10 07:40:15', user: 'admin', action: 'permission.change', resourceType: 'workspace', resource: 'Global WorkSpace', workspace: 'Global WorkSpace', risk: 'medium', ip: '10.0.1.10', detail: { target: 'user_3301', role: 'admin', prev: 'member' }, traceId: null },
    ...
    { id: 'aud_12', createdAt: '2026-06-09 18:22:11', user: 'admin', action: 'agent.delete', resourceType: 'agent', resource: 'test-bot-legacy', workspace: 'Global WorkSpace', risk: 'low', ip: '10.0.1.10', detail: { reason: 'deprecated' }, traceId: null }
  ],
  toolExecutions: [
    ...
    { id: 'tex_08', time: '2026-06-10 07:35:00', user: 'user_3301', type: 'Skill', resource: 'data-export', operation: 'skill.execute', durationMs: 1200, status: 'success', workspace: 'Global WorkSpace', traceId: 'tr_export_01', input: '{"dataset":"users","limit":100}', output: '{"rows":100}', error: null, agent: null, workflow: null },
